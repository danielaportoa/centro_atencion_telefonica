...
class LlamadasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create llamada" do
    assert_difference("Llamada.count") do
      post llamadas_url, params: { llamada: { cliente_id: @llamada.cliente_id, fecha: @llamada.fecha, motivo: @llamada.motivo } }
    end
  ...
  test "should update llamada" do
    patch llamada_url(@llamada), params: { llamada: { cliente_id: @llamada.cliente_id, fecha: @llamada.fecha, motivo: @llamada.motivo } }
